...
export class SubmitQuickBuyEnabledHandler extends BaseMenuCodeHandler<MenuCode.SubmitQuickBuyEnabled> implements MenuCodeHandlerCapabilities {
    constructor(menuCode : MenuCode.SubmitQuickBuyEnabled) {
        super(menuCode);
    }
