export function addAutoDoubleSlippageVerbiage(lines : string[]) {
    ...
    lines.push(':bullet: Choose whether you would like to automatically double the slippage percent every time the TSL fails due to slippage tolerance being exceeded.');
