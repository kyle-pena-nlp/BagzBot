...
export class MenuEditTrailingStopLossPositionRequest extends Menu<LongTrailingStopLossPositionRequest> implements MenuCapabilities {
    ...
    renderOptions(): CallbackButton[][] {
        ...
        this.insertButtonNextLine(options, `Buying With: ${this.miscData!!.vsToken}`, new CallbackData(MenuCode.TrailingStopLossPickVsTokenMenu, this.miscData!!.vsToken.symbol));
