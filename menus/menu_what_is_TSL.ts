...
export class MenuWhatIsTSL extends Menu<{ botDisplayName : string}> implements MenuCapabilities {
    renderText(): string {
        return `${logoHack()}<b><u>What is a TSL?</u></b>

A <b>Trailing Stop Loss</b> (TSL) is an advanced trade type used by fiat traders.

<u>${this.menuData.botDisplayName} is the first bot to offer this trade for Solana, or for any blockchain.</u>
