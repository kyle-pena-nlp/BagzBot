...
export enum MenuCode {
	...
	ChooseQuickBuyEnabled = "CQB.Enabled",
	ChooseQuickBuySOLAmount = "CQB.SOL",
	ChooseQuickBuyTSLTriggerPercent = "CQB.TSLTRIGPCT",
	ChooseQuickBuyPriorityFee = "CQB.PRIORITY",
	ChooseQuickBuySlippagePct = "CQB.SLIP",
	ChooseQuickBuyAutoDoubleSlippage = "CQB.ADSLIP",

	CustomQuickBuySlippagePctAmount = "XQB.SLIP",
	CustomQuickBuyTSLTriggerPercent = "XQB.TSLTRIGPCT",
	CustomQuickBuySOLAmount = "XQB.SOL",

	SubmitQuickBuyEnabled = "SQB.Enabled",
	SubmitQuickBuySOLAmount = "SQB.SOL",
	SubmitQuickBuyTSLTriggerPercent = "SQB.TSLTRIGPCT",
	SubmitQuickBuyPriorityFee = "SQB.PRIORITY",
	SubmitQuickBuySlippagePct = "SQB.SLIP",
	SubmitQuickBuyAutoDoubleSlippage = "SQB.ADSLIP",
};